...
void main() async {
  ...
  // 打印欢迎信息
  print('【GetX Demo】应用已启动');
  print('【GetX Demo】这个演示应用展示了GetX的各种功能：');
  print('【GetX Demo】1. 状态管理 - 简单状态管理和响应式状态管理');
  print('【GetX Demo】2. 依赖注入 - 控制器注入与获取');
  print('【GetX Demo】3. 路由管理 - 无需context的导航');
  print('【GetX Demo】4. 国际化 - 多语言支持');
  print('【GetX Demo】5. 主题管理 - 动态切换主题');
  print('【GetX Demo】6. 数据持久化 - 使用GetStorage存储数据');
}
